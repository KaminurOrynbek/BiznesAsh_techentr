...
const itemClass = ({ isActive }: { isActive: boolean }) =>
  `relative px-1 py-2 text-sm font-semibold transition-colors ${isActive ? "text-brand-700 dark:text-brand-400" : "text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100"
  }`;
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                <Link
                  ...
                  title={t('profile')}
                >
                  <div className="w-9 h-9 rounded-full bg-brand-50 dark:bg-brand-900/20 flex items-center justify-center text-brand-700 dark:text-brand-400 text-xs font-bold border border-brand-100 dark:border-brand-800">
