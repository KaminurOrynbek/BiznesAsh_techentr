...
type PaymentServiceClient interface {
	...
	GetTransactionHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*HistoryResponse, error)
}
...
func (c *paymentServiceClient) GetTransactionHistory(ctx context.Context, in *GetHistoryRequest, opts ...grpc.CallOption) (*HistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PaymentServiceServer interface {
	...
	GetTransactionHistory(context.Context, *GetHistoryRequest) (*HistoryResponse, error)
...
func (UnimplementedPaymentServiceServer) GetTransactionHistory(context.Context, *GetHistoryRequest) (*HistoryResponse, error) {
...
func _PaymentService_GetTransactionHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetTransactionHistory(ctx, req.(*GetHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
