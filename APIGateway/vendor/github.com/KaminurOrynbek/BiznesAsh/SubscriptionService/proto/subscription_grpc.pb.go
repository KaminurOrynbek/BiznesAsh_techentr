...
const (
	...
	SubscriptionService_GetSubscriptionHistory_FullMethodName = "/subscription.SubscriptionService/GetSubscriptionHistory"
...
type SubscriptionServiceClient interface {
	...
	GetSubscriptionHistory(ctx context.Context, in *GetSubscriptionRequest, opts ...grpc.CallOption) (*ListSubscriptionsResponse, error)
...
func (c *subscriptionServiceClient) GetSubscriptionHistory(ctx context.Context, in *GetSubscriptionRequest, opts ...grpc.CallOption) (*ListSubscriptionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSubscriptionsResponse)
	err := c.cc.Invoke(ctx, SubscriptionService_GetSubscriptionHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *subscriptionServiceClient) ListSubscriptions(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListSubscriptionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListSubscriptionsResponse)
...
type SubscriptionServiceServer interface {
	...
	GetSubscriptionHistory(context.Context, *GetSubscriptionRequest) (*ListSubscriptionsResponse, error)
...
func (UnimplementedSubscriptionServiceServer) GetSubscriptionHistory(context.Context, *GetSubscriptionRequest) (*ListSubscriptionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSubscriptionHistory not implemented")
}
func (UnimplementedSubscriptionServiceServer) ListSubscriptions(context.Context, *Empty) (*ListSubscriptionsResponse, error) {
...
func _SubscriptionService_GetSubscriptionHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSubscriptionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SubscriptionServiceServer).GetSubscriptionHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SubscriptionService_GetSubscriptionHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionServiceServer).GetSubscriptionHistory(ctx, req.(*GetSubscriptionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _SubscriptionService_ListSubscriptions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SubscriptionServiceServer).ListSubscriptions(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SubscriptionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SubscriptionService_GetSubscriptionHistory_Handler,
		},
		{
